...
const Logo = () => (
  <svg className="logo" height="27" id="logo" viewBox="0 0 587.93 165" width="85">
...
const Fistbump = () => (
  <svg data-name="Layer 1" id="Layer_1" viewBox="0 0 32 32" width="27" xmlns="http://www.w3.org/2000/svg">
    ...
    <polygon fill="#050505" points="16.42 8 6.75 12.47 9.16 21.64 11 21.41 10.49 15.65 11.1 15.38 12.13 21.27 15.27 20.89 14.71 14.53 15.3 14.27 16.45 20.75 19.62 20.36 19.01 13.38 19.61 13.12 20.86 20.2 24 19.82 24 9.89 16.42 8"></polygon>
...
function TopNav() {
  return (
    <Navbar className="p-0 px-lg-2" fixed="top" id="topNav">
      <Container fluid>
        <Nav className="align-items-center">
          <Logo />
          <Fistbump />

          <NavDropdown title="WHO WE ARE" id="M2DropdownLink" className="d-none d-lg-block riotDropLabel">
          ...
          <NavDropdown title="WORK WITH US" id="M3DropdownLink" className="d-none d-lg-block">
        ...
        <Nav className="justify-content-end" id="rightNavTop">
          ...
          <Nav.Item style={{marginRight: '20px'}}>
            <Button className="d-flex justify-content-center align-items-center col navBtn btn btn-outline-secondary" href="#" id="signIn" style={{minWidth: '98px', minHeight: '35px'}}>SIGN IN</Button>
          </Nav.Item>
        </Nav>
      </Container>
    </Navbar>
    ...
    <div className="song-of-nunu">
      <Container fluid>
        <Row className="container" id="nunuInfo">
          <Container>
            <Image alt="Nunu" className="nunu" id="nunuImg" src="./images/son-light-logo-png-600.png" />
    ...
    <Row className="games m-0 px-lg-3 mt-5">
      <Col>
        ...
        <Row className="mx-5 mb-4 mt-5 justify-content-center">
          {renderGameCard('League of Legends', 'images/lol-logotype.png', 'cardLOL', [Windows, Apple])}
          {renderGameCard('Valorant', 'images/valorant-logotype.png', 'cardValorant', [Windows])}
        </Row>

        <Row className="mx-5 my-4 justify-content-center">
          {renderGameCard('Team Fight Tactics', 'images/tft-logotype-2021.png', 'cardTFT', [Windows, Apple, Phone])}
          {renderGameCard('League of Legends Wild Rift', 'images/lol-wildrift-logotype.png', 'cardLOLWR', [Phone])}
        </Row>

        <Row className="mx-5 mt-4 mb-5 justify-content-center">
          {renderGameCard('Legends of Runeterra', 'images/legends-of-runeterra-logotype.png', 'cardLOR', [Windows, Phone], 'col-md-6')}
        </Row>
      </Col>
    </Row>
  );
    ...
    <Row className="esports m-0 px-lg-3">
      <Col>
        ...
        <Row className="m-5 justify-content-center">
          {renderEsportsCard('League of Legends Esports', 'images/lol-esports-logo-full.png', 'cardLOLEsport')}
          {renderEsportsCard('Valorant Championship Tour', 'images/val-esports-logo-2023.png', 'cardVCT')}
        </Row>
      </Col>
    </Row>
  )
  ...
  return (
    <Row className="entertainment m-0 px-lg-3">
      <Col>
        ...
        <Row className="m-5 justify-content-center">
          {renderEntertainmentCard('League of Legends', 'images/arcane-logo-white.png', 'cardArcane')}
          {renderEntertainmentCard('Riot Games Music', 'images/riotgames-music.png', 'cardMusic')}
        </Row>
      </Col>
    </Row>
  )
...
const cardsData = [
  { id: 'cardMageSeeker', imgSrc: 'images/mageseeker-logo-white.png', imgAlt: 'The Mageseeker LoL', platforms: ['playstation', 'xbox'], hasPhone: false },
  { id: 'cardRuinedKing', imgSrc: 'images/ruined-king-logotype.png', imgAlt: 'Ruined King', platforms: ['playstation', 'xbox'], hasPhone: false },
  { id: 'cardHextech', imgSrc: 'images/hextech-mayhem-logotype.png', imgAlt: 'League of Legends', platforms: [], hasPhone: true },
  { id: 'cardConvrgence', imgSrc: 'images/convrgence-logotype.png', imgAlt: 'Convrgence', platforms: [], hasPhone: false },
  { id: 'cardNunu', imgSrc: 'images/songofnunu-logotype.png', imgAlt: 'Song of Nunu', platforms: ['playstation', 'xbox'], hasPhone: false },
];
        ...
        <Row>
          <Col style={{ padding: 0 }}>
            <Row>
                  ...
                  <Row>
                    <a className="riotButton d-flex align-items-center justify-content-center col btn btn-outline-secondary" href="#" id="firstBumpFooter" style={{ padding: 0 }} type="button">
                      <svg className="d-flex align-items-center" dataname="Layer 1" height="40" id="firstBumpFooterSVG" viewBox="0 0 185.47 163.51" width="38">
                        <path className="cls-1" d="M98.77 0L0 45.74l24.61 93.66 18.73-2.3-5.15-58.89 6.15-2.74 10.62 60.2 32.01-3.93-5.69-65 6.09-2.71 11.68 66.23 32.38-3.98-6.23-71.25 6.16-2.74 12.77 72.43 32.01-3.93V19.38L98.77 0zm2.32 142.05l1.63 9.22 73.42 12.24v-30.68l-75.01 9.21-.04.01zM176.17.71V0h3.64v.71zm1.41 3.94V.4h.81v4.25zm3 0V0h.8v4.65zm2.21 0L180.73 0h.83L183 3.41 184.44 0h.84l-2.06 4.65zm1.83 0V0h.81v4.65z"></path>
                      </svg>
                    </a>
              ...
              <Col className="d-flex" style={{ justifyContent: 'flex-end', padding: 0 }}>
                <Navbar style={{ padding: 0 }}>
                  <Nav className="justify-content-end">
                    <Nav.Link className="riotButton d-flex justify-content-center align-items-center col-1 btn btn-outline-secondary" href="#" type="button"><Facebook /></Nav.Link>
                    <Nav.Link className="riotButton d-flex justify-content-center align-items-center col-1 btn btn-outline-secondary" href="#" type="button"><Twitter /></Nav.Link>
                    <Nav.Link className="riotButton d-flex justify-content-center align-items-center col-1 btn btn-outline-secondary" href="#" type="button"><Linkedin /></Nav.Link>
                    <Nav.Link className="riotButton d-flex justify-content-center align-items-center col-1 btn btn-outline-secondary" href="#" type="button"><Youtube /></Nav.Link>
                  </Nav>
                </Navbar>
              </Col>
            </Row>
            ...
            <div className="col-12 pt-3" style={{ position: 'relative' }}>
              <div className="col-5" id="copyright" style={{ position: 'absolute', bottom: '-28px', left: '15px' }}>
                              <span style={{ width: '2px', height: '20px', lineHeight: '20px' }}>
                                <svg fill="gray" height="22" viewBox="0 0 2 40"><path d="M1.7 4.2s.1-.1 0-.1c.1-.3 0-1.8 0-2.1.1-.5 0-.8.2-1.2 0 0-.2-.5-.2-.1 0-.2-.1 0-.2 0V.6C1.4.6.9.6.9.3.7.5.5.1.3.3.1.5.3 1.4.3 1.7c-.1.4-.1 1.2-.1 2-.1 3 0 6.1-.1 9.1 0 1 0 2-.1 3 0 1.6.2 3.2.2 4.8 0 2.7-.1 5.5 0 8.2 0 2 0 4 .1 5.9.1 1 .2 2.6 0 3.3-.1.2 0 .7 0 .9 0 .1.1.5.1.4.3 0 .2.6.4.7.4.3.5-.4.6-.7.3.3.2-.8.2-1v-8.6c0-3.5.1-7 .1-10.5v-4.5c0-.3-.1-1 .1-1.2V8.9c0-.8-.1-1.6 0-2.4 0-.5-.1-1.4.1-1.7-.2-.2-.2-.4-.2-.6M1.8.5s0 .1 0 0zM.3 38.3zM1.8.7c0-.1 0-.1 0 0z"></path></svg>
                              </span>
